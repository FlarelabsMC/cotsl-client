...
public final class MixinsClient {
    public static class EntityRenderDispatcherMixin {
        public void submit_submitFlame(PoseStack poseStack,
    ...
    public static class AvatarRendererMixin<AvatarlikeEntity extends Avatar> {
        ...
        public void extractRenderState(AvatarlikeEntity entity,
            ...
            if (Frankenstein.isPlaceholder(hairId)) {
                Identifier newHairTexture =
                        Identifier.fromNamespaceAndPath(
                                "cotsl", "skin/hair/hair_" + data.hair() + "_color"
                        );
                Identifier newHairModel =
                        Identifier.fromNamespaceAndPath(
                                "cotsl", "skin/hair/hair_" + data.hair()
                        );
            ...
            if (Frankenstein.isPlaceholder(skinId)) {
                CharData newData = CharData.init().rebuild()
                        .bodyType(2)
                        .shirtColor(0x435241)
                        .pantsColor(0xc4ba86)
                        .headShape(3)
